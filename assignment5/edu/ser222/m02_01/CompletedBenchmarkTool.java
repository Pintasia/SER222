...
public class CompletedBenchmarkTool implements BenchmarkTool {
    ...
    public void runBenchmarks(int size) {
        ...
        // benchmark all
        double binInsert = benchmarkInsertionSort(binSmall, binLarge);
        double binShell = benchmarkShellsort(binSmall, binLarge);

        double halfInsert = benchmarkInsertionSort(halfSmall, halfLarge);
        double halfShell = benchmarkShellsort(halfSmall, halfLarge);

        double randInsert = benchmarkInsertionSort(randSmall, randLarge);
        double randShell = benchmarkShellsort(randSmall, randLarge);

        // output results
        System.out.printf("       Insertion  Shellsort\n");
        System.out.printf("Bin    " + DF.format(binInsert) + "      " + DF.format(binShell) + "\n");
        System.out.printf("Half   " + DF.format(halfInsert) + "      " + DF.format(halfShell) + "\n");
        System.out.printf("RanInt " + DF.format(randInsert) + "      " + DF.format(randShell) + "\n");
    }
